...
login.addEventListener("click", function() {
  ...
  console.log("companyCode : "+companyCode.value);
  console.log("workplaceCode : "+workplaceCode.value);
  $.ajax({
    type: 'GET',
    url: '/hr/login.do', //   contextPath 없어도 가능 -> 서버를 artifact 를  조작하면 됨...
    data: {
      method: 'LogInCheck',
...
const companyData = () => {
  $.ajax({
    type: 'GET',
    url: '/compinfo/searchCompany.do', //   contextPath 없어도 가능 -> 서버를 artifact 를  조작하면 됨...
    data: {
...
const workplaceData = () => {
  $.ajax({
    type: 'GET',
    url: '/compinfo/searchWorkplace.do', //   contextPath 없어도 가능 -> 서버를 artifact 를  조작하면 됨...
    data: {
      companyCode: companyCode.value,
