...
<script src="${pageContext.request.contextPath}/js/datepickerUse.js"
	defer></script>
<script
...
<body>
	<article class="estimate">
		<div class="estimate_Title">
			<h5>📋 견적등록</h5>
			<span style="color: black">견적등록일자</span><br /> <input type="text"
				id="datepicker" placeholder="YYYY-MM-DD👀" size="15"
			...
			<div class="menuButton">
				...
				<button id="batchSaveButton"
					style="float: right; background-color: #F15F5F">일괄저장</button>
				<div class="menuButton__selectCode">
					<button class="search" id="customerList" data-toggle="modal"
						data-target="#listModal">거래처코드</button>
				</div>
			</div>
		</div>
	</article>
	...
	<article class="estimateDetailGrid">
		<div align="center" class="ss">
			<div id="myGrid2" class="ag-theme-balham"
				style="height: 50vh; width: auto;"></div>
		</div>
	</article>

	<J2H:listModal />
	<!-- 조회 모달 -->
	<!-- 견적상세등록 제목 바로 밑에 있는 버튼이 아니라 ag-Grid 큰 표에 있는 컬럼명? 이라고 볼 수 있다. -->
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="width: auto; text-align: left">
						<label style='font-size: 20px; margin-right: 10px'>견적수량</label> <input
							type='text' id='estimateAmountBox' autocomplete="off" /><br>
						<label for='unitPriceOfEstimateBox'
							style='font-size: 20px; margin-right: 10px'>견적단가</label> <input
							type='text' id='unitPriceOfEstimateBox' autocomplete="off" /><br>
						<label for='sumPriceOfEstimateBox'
							style='font-size: 20px; margin-right: 30px'>합계액 </label> <input
							type="text" id='sumPriceOfEstimateBox' autocomplete="off"></input>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" id="amountSave" class="btn btn-default"
